/**
 * @author Carter Bartz
 * Test class for lab 3 problem 2
 */
...
public class Test2{
    public static void main(String[]args){
         //Create a LLSymbolTable object
        LLSymbolTable<Integer, Integer> table = new LLSymbolTable<Integer, Integer>();
        //Read in the file
     ...
     */
    public static void readFile(LLSymbolTable<Integer, Integer> table, String filename){
        try{
     ...
     */
    public static void printKeyValuePairs(LLSymbolTable<Integer, Integer> table){
