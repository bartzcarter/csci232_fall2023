/**
    ...
    @author Houria Oudghiri/Carter Bartz
...
public class Sort{
    ...
    /**
        subList method for merge sort
        @param list to be sorted
        @param  start index to start copy
        @param  end index to end copy
        time complexity: O(n)
     */
    ...
    /**
        heapSort
        @param list to be sorted using the Heap
        time complexity: O(nlogn)
        space complexity: O(n)
     */
        ...
        for(int d=0; d<digits; d++) {
            ...
            for(int j=0; j<10; j++) {
                ...
                for(int l=0; l<bucket.size(); l++){
                    iterations[7]++;
                    list.set(list.get(k++), bucket.get(l));
                }
            }
