...
public class HashMap <K, V> {
    ...
    /**
        ...
        Time Complexity: O(1) if no rehash(); O(n) if rehash();
	 */
    ...
    */
    ...
    /**
        Method to determine the max number of collisions in the hashTable
        @return max-1 the number of collisions
        Time Complexity: O(n)
     */
