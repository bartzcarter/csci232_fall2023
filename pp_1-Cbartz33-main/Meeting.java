...
public class Meeting extends Event{
    ...
    no parameters
    calls the super() constructor and initializes data member host to "null", and guests to 0
    */
    public Meeting(){
        super();
        host = "null";
    ...
    public String toString(){
        return String.format("Type: Meeting\t\t%10s\t\tHost: %10s\t\tGuests: %d", super.toString(), host, guests);
    }
}
